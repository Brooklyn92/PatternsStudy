...
/*
Может быть чисто абстрактным (интерфейсом) или содержать реализацию.
Фабричные методы могут быть параметризированы с целью создания разных видов продуктов.
 */
